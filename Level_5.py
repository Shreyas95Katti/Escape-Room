...
class Puzzle(object):
	...
	def picture(self):
		riddle = pg.image.load("riddle.jpg")
		(self.screen).blit(riddle,(100,200))

	def inputbox(self,event):
		Input = InputBox(475, 450, 140, 40)
		self.input = Input
...
class Room5(object):
	...
	def Room_5(self,Mainwindow):
		...
		clock = pg.time.Clock()
		bg = pg.image.load("Room_5_bg.jpg")
		...
		inputbox = InputBox(475, 450, 140, 40)
		...
		while True:
			...
			text = font.render('Room 5', True, (255,255,255))
