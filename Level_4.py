...
class Puzzle(object):
	...
	def draw_clue(self):
		self.x1 = 1600
		self.y1 = 370
		self.Pos = Vector2(self.x1,self.y1)
		clue_rect = pg.Rect(self.Pos.x,self.Pos.y,cell_size,cell_size)
		pg.draw.rect(self.screen,(255,255,255),clue_rect)

	def picture(self):
		Message = pg.image.load("Encoded.jpg")
		(self.screen).blit(Message,(100,200))

	def Clue(self):
		clue = pg.image.load("Clue.jpg")
		(self.screen).blit(clue,(100,200))

	def inputbox(self,event):
		Input = InputBox(475, 860, 140, 40)
		self.input = Input
...
class Room4(object):
	...
	def Room_4(self,mainWindow):
		...
		def Level5():
			...
			self.ui = Room5()
			self.ui.Room_5(self.window)
			self.window.showMaximized()


		screen = pg.display.set_mode((1920,1000))
		clock = pg.time.Clock()
		bg = pg.image.load("Room_4_bg.jpg")
		...
		inputbox = InputBox(475, 860, 140, 40)
		...
		while True:
			...
			text = font.render('Room 4', True, (255,255,255))
			textRect = text.get_rect()
			textRect.center = (200,100)
			screen.blit(text,textRect)

			font1 = pg.font.Font('Poppins-Regular.ttf',30)
			text1 = font1.render('White - Clue', True, (255,255,255))
			text2 = font1.render('Black - Puzzle', True, (255,255,255))
			textRect1 = text1.get_rect()
			textRect2 = text2.get_rect()
			textRect1.center = (1645,450)
			textRect2.center = (1650,500)
