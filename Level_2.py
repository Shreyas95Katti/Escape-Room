...
class Puzzle(object):
	...
	def picture(self):
		riddle = pg.image.load("Level2_question.jpg")
		(self.screen).blit(riddle,(100,200))

	def inputbox(self,event):
		Input = InputBox(300, 650, 300, 40)
		self.input = Input
...
class Room2(object):
	...
	def Room_2(self,mainWindow):
		...
		def Level3():
			...
			self.ui = Room3()
			self.ui.Room_3(self.window)
			self.window.showMaximized()

		screen = pg.display.set_mode((1920,1000))
		clock = pg.time.Clock()
		bg = pg.image.load("Room2_bg.jpg")
		...
		inputbox = InputBox(200, 675, 300, 40)
		...
		while True:
			...
			text = font.render('Room 2', True, (255,255,255))
			...
			for event in pg.event.get():
				...
				if input_answer=="cliffhanger,instance,contempt":
					b = 1
